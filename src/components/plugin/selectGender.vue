...
<script>
    ...
    export default {
        ...
        props: ["selected"],
        mounted() {
            //setTimeout(lookupController.setLookupItems("EP_LKP_GENDER_TYPE"), 200);
        ...
        computed: {
            list() {
                return store.getters.getLookupItems("EP_LKP_GENDER_TYPE");
            },
            locale() {
        ...
        methods: {
            sendId() {
                this.$emit("getGenderCode", this.code);
            }
        },
        watch: {
